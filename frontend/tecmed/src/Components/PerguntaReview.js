...
const PerguntaReview = ({pergunta1, pergunta2, pergunta3, videoId}) => {
    ...
    let act = `/review/Quiz/VideoId=${videoId}`
        ...
        <div className='Review'>
            <form action = {act}>
                ...
                <div>
                    ...
                    <input type="radio" name="resposta1" value="7"/>
                ...
                <div>
                    ...
                    <input type="radio" name="resposta2" value="7"/>
                ...
                <div>
                    ...
                    <input type="radio" name="resposta3" value="7"/>
